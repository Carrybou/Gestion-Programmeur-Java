...
INSERT INTO programmeur (nom, prenom, anNaissance, salaire, prime, email, date_embauche, actif) VALUES
                                                                                                    ('Dupont', 'Jean', 1995, 32000.00, 1500.00, 'jean.dupont@example.com
', '2022-01-10', TRUE),
                                                                                                    ('Martin', 'Claire', 1990, 38000.00, 2000.00, 'claire.martin@example.com
','2021-03-01', TRUE),
                                                                                                    ('Durand', 'Paul', 1988, 29000.00, 800.00, 'paul.durand@example.com
', '2023-09-15', TRUE);
